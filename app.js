  ...
  const themes = {
    7: {
      weeks: [
        // 第1周 感知引入（6天×6维度）
        [
          ['小方绘本《水果》认识水果', '苹果apple,香蕉banana', '自由玩耍', '', '', ''],
          ['复习小方绘本《水果》', '复习apple,banana,学习橘子orange', '自由玩耍', '', '', ''],
          ['复习', '复习apple,banana,orange,学习葡萄grape', '玩实物水果（苹果、橘子、葡萄），摸水果表皮（光滑vs粗糙）', '', '英文歌Apple round, apple red...苹果圆，苹果红...', ''],
          ['复习', '复习', '', '数葡萄1-5个', '', ''],
        ...
        // 第2周 词汇积累
        [
          ['通过水果玩具认识苹果、香蕉、橘子、葡萄、西瓜、梨、草莓、桃子、柠檬、杨桃、猕猴桃', '西瓜watermelon,桃子peach', '', '', '', ''],
        ...
        [
          ...
          ['复习小方绘本《蔬菜》', '复习', '观察蔬菜颜色（红番茄、绿菜心、黄玉米、白花菜），触摸蔬菜质地（软硬）、闻蔬菜气味', '', '', ''],
        ...
        [
          ...
          ['布书《水果蔬菜》', '', '讲述蔬菜和水果的差别：蔬菜指植物根茎叶花蕾，水果指果实。蔬菜常烹饪，水果常新鲜食用', '用布书粘贴分类：水果vs蔬菜', '', '鼓励自己吃饭'],
          ['本周复习', '碗bowl,碟子plate,勺子spoon', '本周复习', '本周复习', '画圆', '鼓励自己吃饭'],
          ['月度复习', '月度复习', '月度复习', '月度复习', '月度复习', '']
        ],
        // 第5周 巩固拓展（逛超市/菜市场）
        [
          ['绘本《菜市场》认识更多食物', '面包bread,大米rice', '', '', '', ''],
          ['复习', '复习', '', '', '', ''],
          ['复习', '复习', '', '', '', ''],
          ['复习', '复习', '', '', '', ''],
          ['复习', '复习', '', '', '', ''],
        ...
        // 第6周 总结庆祝（美食派对）
        [
          ['复习食物词汇：水果、蔬菜、主食', '复习apple,banana,orange,grape,watermelon,rice,bread', '观察不同食物的形状和颜色', '数水果玩具1-5', '画最喜欢的水果', '和妈妈一起准备食材'],
          ['复习', '复习carrot,tomato,egg,milk', '', '数蔬菜玩具1-5', '', ''],
          ['复习', '复习', '', '比较水果大小排序', '英文歌Apple round复习', ''],
          ['复习', '复习bowl,plate,spoon', '', '水果分类游戏', '白板画食物', '尝试自己用勺子吃东西'],
          ['复习', '本周所有英文单词复习', '', '食物数量游戏', '粘贴食物手工', ''],
          ['月度总复习', '月度总复习', '月度总复习', '月度总复习', '画本月最喜欢的食物', '美食派对']
        ]
      ],
    ...
    8: {
      weeks: [
        ...
        // 第6周 总结庆祝（时装秀）
        [
          ['复习衣物词汇：衣服、裤子、袜子、鞋子、帽子', '复习shirt,pants,shoe,sock,hat,coat', '观察不同衣物的颜色', '数衣物玩具1-5', '画最喜欢的衣服', '和妈妈一起搭配衣服'],
          ['复习', '复习scarf,glove,dress,raincoat', '', '数衣物配对', '', ''],
          ['复习', '复习', '', '衣服大小排序', '英文歌Put on your shirt复习', ''],
          ['复习', '复习put on, take off, hot, cold', '', '衣物分类游戏', '白板画衣服', '尝试自己穿袜子'],
          ['复习', '本周所有英文单词复习', '', '衣物数量游戏', '粘贴衣服手工', ''],
          ['月度总复习', '月度总复习', '月度总复习', '月度总复习', '画本月最喜欢的衣物', '家庭时装秀']
        ]
      ],
      summary: ['认识衣服', '鞋袜世界', '穿衣实践', '季节衣物', '商场探险拓展', '家庭时装秀']
    },
    9: {
      weeks: [
        // 第1周 感知引入（认识房间）
        ...
        // 第6周 总结庆祝（我的家展示）
        [
          ['复习房间词汇：门、窗、床、桌、椅', '复习door,window,bed,table,chair', '观察不同房间的物品', '数家具玩具1-5', '画最喜欢的房间', '和妈妈一起整理玩具'],
          ['复习', '复习sofa,fridge,cabinet,lamp', '', '数房间配对', '', ''],
          ['复习', '复习', '', '家具大小排序', '英文歌Open the door复习', ''],
          ['复习', '复习up,down,in,out,open,close', '', '房间物品分类游戏', '白板画房子', '尝试自己收拾玩具'],
          ['复习', '本周所有英文单词复习', '', '房间数量游戏', '粘贴房子手工', ''],
          ['月度总复习', '月度总复习', '月度总复习', '月度总复习', '画我的家', '我的家展示']
        ]
      ],
      summary: ['我的家', '家具认知', '方位游戏', '家庭生活', '公园探险拓展', '我的家展示']
    },
    10: {
      weeks: [
        // 第1周 感知引入（常见动物）
        ...
        // 第5周 巩固拓展（去动物园）
        [
          ['绘本《去动物园》认识更多动物', '猴子monkey,大象elephant', '', '', '', ''],
          ['复习', '复习', '', '', '', ''],
          ['复习', '复习', '', '', '', ''],
          ['复习', '复习', '', '', '', ''],
          ['复习', '复习', '', '', '', ''],
        ...
        // 第6周 总结庆祝（动物派对）
        [
          ['复习动物词汇：猫、狗、兔、鸟、鱼、鸡、鸭、牛', '复习cat,dog,rabbit,bird,fish,chicken,duck', '观察不同动物的颜色和大小', '数动物玩具1-5', '画最喜欢的动物', '和妈妈一起模仿动物'],
          ['复习', '复习cow,pig,tail,foot,big,small', '', '数动物配对', '', ''],
          ['复习', '复习', '', '动物大小排序', '英文歌Old MacDonald复习', ''],
          ['复习', '复习butterfly,bee,frog,snail,monkey,elephant', '', '动物分类游戏', '白板画动物园', '尝试模仿更多动物'],
          ['复习', '本周所有英文单词复习', '', '动物数量游戏', '粘贴动物手工', ''],
          ['月度总复习', '月度总复习', '月度总复习', '月度总复习', '画本月最喜欢的动物', '动物角色扮演派对']
        ]
      ],
      summary: ['家养动物', '农场动物', '动物特征', '动物古诗', '动物园探险', '动物派对']
    },
    11: {
      weeks: [
        // 第1周 感知引入（花草认知）
        ...
        // 第6周 总结庆祝（小花园展示）
        [
          ['复习植物词汇：花、草、树、叶子、种子', '复习flower,grass,tree,leaf,seed', '观察水培植物的生长变化', '数植物玩具1-5', '画最喜欢的植物', '和妈妈一起照顾植物'],
          ['复习', '复习cactus,sunflower,mushroom,fruit', '', '数叶子配对', '', ''],
          ['复习', '复习', '', '植物大小排序', '英文歌flower flower复习', ''],
          ['复习', '复习water,grow,rain,sun,red,green,blue,yellow', '', '植物分类游戏', '白板画花园', '展示水培成果'],
          ['复习', '本周所有英文单词复习', '', '植物数量游戏', '粘贴植物手工', ''],
          ['月度总复习', '月度总复习', '月度总复习', '月度总复习', '画我的小花园', '小花园展示']
        ]
      ],
      summary: ['认识花草', '认识树木', '水培种植', '植物与生活', '植物园探险', '小花园展示']
    },
    12: {
      weeks: [
        // 第1周 感知引入（海洋生物）
        ...
        // 第5周 巩固拓展（去水族馆）
        [
          ['绘本《去水族馆》认识更多海洋生物', '鲨鱼shark,企鹅penguin', '', '', '', ''],
          ['复习', '复习', '', '', '', ''],
          ['复习', '复习', '', '', '', ''],
          ['复习', '复习', '', '', '', ''],
          ['复习', '复习', '', '', '', ''],
        ...
        // 第6周 总结庆祝（海洋派对）
        [
          ['复习海洋词汇：鱼、虾、螃蟹、海星、乌龟', '复习fish,shrimp,crab,starfish,turtle', '观察水培海洋动物玩具', '数海洋动物玩具1-5', '画最喜欢的海洋生物', '和妈妈一起玩水'],
          ['复习', '复习dolphin,whale,octopus,jellyfish', '', '数海洋动物配对', '', ''],
          ['复习', '复习', '', '海洋动物大小排序', '英文歌Baby shark复习', ''],
          ['复习', '复习water,swim,deep,shallow,blue,white', '', '海洋动物分类游戏', '白板画海底世界', '展示沉浮实验'],
          ['复习', '本周所有英文单词复习', '', '海洋数量游戏', '粘贴海洋手工', ''],
          ['月度总复习', '月度总复习', '月度总复习', '月度总复习', '画海底世界', '海洋派对']
        ]
      ],
      summary: ['认识海洋动物', '海洋生物', '水的特性', '海洋世界', '水族馆探险', '海洋派对']
    },
    1: {
      weeks: [
        // 第1周 感知引入（认识天空）
        ...
        // 第6周 总结庆祝（天空画展）
        [
          ['复习天空词汇：太阳、月亮、星星、云、风、雨', '复习sun,moon,star,cloud,wind,rain', '观察窗外的天空', '数星星/云朵图片1-5', '画最喜欢的天空事物', '和妈妈一起看日落'],
          ['复习', '复习rainbow,sunny,cloudy', '', '数天气配对', '', ''],
          ['复习', '复习', '', '天空事物大小排序', '英文歌Twinkle twinkle复习', ''],
          ['复习', '复习day,night,bright,dark,morning,evening,hot,cold', '', '天气分类游戏', '白板画天空', '夜晚看星星'],
          ['复习', '本周所有英文单词复习', '', '天空数量游戏', '粘贴天空手工', ''],
          ['月度总复习', '月度总复习', '月度总复习', '月度总复习', '画美丽的天空', '天空画展']
        ]
      ],
      summary: ['认识天空', '天气变化', '白天黑夜', '天空与生活', '天空探险拓展', '天空画展']
    },
    2: {
      weeks: [
        // 第1周 感知引入（地球月亮太阳）
        ...
        // 第5周 巩固拓展（科技馆/天文馆）
        [
          ['绘本《去科技馆》认识更多太空知识', '行星planet,银河galaxy', '', '', '', ''],
          ['复习', '复习', '', '', '', ''],
          ['复习', '复习', '', '', '', ''],
          ['复习', '复习', '', '', '', ''],
          ['复习', '复习', '', '', '', ''],
        ...
        // 第6周 总结庆祝（太空探险派对）
        [
          ['复习太空词汇：地球、月亮、太阳、星星、火箭', '复习earth,moon,sun,star,rocket', '摸地球仪和太空玩具', '数星球玩具1-5', '画最喜欢的太空事物', '和妈妈一起看星空'],
          ['复习', '复习astronaut,space,spaceship', '', '数太空配对', '', ''],
          ['复习', '复习', '', '太空事物大小排序', '英文歌Star light star bright复习', ''],
          ['复习', '复习fly,high,up,down,circle,big,light,far', '', '太空分类游戏', '白板画太空', '纸飞机比赛'],
          ['复习', '本周所有英文单词复习', '', '太空数量游戏', '粘贴火箭手工', ''],
          ['月度总复习', '月度总复习', '月度总复习', '月度总复习', '画太空探险', '太空探险派对']
        ]
      ],
      summary: ['认识星空', '太阳系启蒙', '太空探索', '太空与生活', '科技馆探险', '太空探险派对']
    }
  };
  ...
  for (const cfg of monthConfig) {
    ...
    for (let w = 0; w < 6; w++) {
      ...
      weeks.push({
        ...
        summary: t.summary[w] + '：' + t.weeks[w][0][0] + '等核心内容复习与巩固',
        days: days
      });
    }
    data[cfg.month] = {
    ...
    html += `
      <div class="week-card ${wi > 0 ? 'collapsed' : ''}" id="week-${wi}">
        <div class="week-card-header" style="background:${stageColor};" onclick="toggleWeek(${wi})">
          <h3 style="color:${cfg.color};">第${wi + 1}周（D${wi*6+1}-D${wi*6+6}）：${week.stageName}</h3>
              ...
              <tbody>
                ${week.days.map(day => `
                  <tr>
                    ...
                    ${dimKeys.map(k => `
                      <td class="editable ${state.isAdmin ? 'admin-mode' : ''}"
                        onclick="editCell(${wi}, ${day.day - 1 - wi*6}, '${k}')"
                          data-week="${wi}" data-day="${day.day - 1 - wi*6}" data-key="${k}">
